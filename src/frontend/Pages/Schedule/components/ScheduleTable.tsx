...
import Schedule from "src/frontend/Pages/Schedule//components/Schedule";

/**
 * Schedule Table Component
 * @param selectedSchedule selected schedule to render
 * @returns rendered Schedule Table component
 */
