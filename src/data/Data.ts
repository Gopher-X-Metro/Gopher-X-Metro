...
namespace Data {
    ...
    export class Direction extends _Direction {
         ...
         * @param routeId id of route that contains the direction
         */
        ...
        /**
         * Gets direction object from Data
         * @param routeId id route direction is in
         * @param directionId id of direction
    ...
    export class Vehicle extends _Vehicle {
         ...
         * @param routeId id of route that contains the vehicle 
         * @param data data of vehicle
         */
        ...
        /**
         * Gets Vehicle from the Data object
         * @param routeId id of route that contains the vehicle
         * @param vehicleId id of vehicle
    ...
    export class Place extends _Place {
         ...
         * @param directionId id of direction that contains the place
         * @param routeId id of route that contains the place
    ...
    export class Departure extends _Departure {
         ...
         * @param routeId id of route that contains the departure
         * @param directionId id of direction that contains the departure
         * @param placeId id of place that contains the departure
    ...
    export class Stop extends _Stop {
         ...
         * @param placeId id of place that contains the stop
         * @param directionId id of direction that contains the stop
         * @param routeId id of route that contains the stop
         * @param data  data of stop
         */
