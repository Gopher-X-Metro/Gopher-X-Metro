...
export default class _Place extends _DataAbstract {
    ...
    /**
     * Constrctor for _Place class
     * @param placeId id of place
     * @param directionId id of direction that contains this place
     * @param routeId id of route that contains this place
    ...
    public async loadDepartures() : Promise<void> {
        this.departures.clear();
