...
export default class _Stop extends _DataAbstract {
    ...
    /**
     * Constructor for _Stop class
     * @param stopId id of stop   
     * @param placeId id of place that contains this stop
     * @param directionId id of direction that contains this stop
     * @param routeId id of route that contains this stop
     * @param data data of stop obtained from _Place
     */
